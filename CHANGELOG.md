...
- HAProxy resources are now named using the pattern `rfrh-[redis-failover-name]`
- The Redis headless service is now named using the pattern `rfrh-[redis-failover-name]`
