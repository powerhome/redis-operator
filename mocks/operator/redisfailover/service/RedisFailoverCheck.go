...
func (_m *RedisFailoverCheck) CheckNumberRedisConnectedSlaves(masterIP string, rFailover *v1.RedisFailover) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CheckNumberRedisConnectedSlaves")
	}
...
// CheckSentinelMonitor provides a mock function with given fields: sentinel, sentinelPort, monitor
func (_m *RedisFailoverCheck) CheckSentinelMonitor(sentinel string, sentinelPort string, monitor ...string) error {
	_va := make([]interface{}, len(monitor))
	for _i := range monitor {
		_va[_i] = monitor[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, sentinel, sentinelPort)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	if rf, ok := ret.Get(0).(func(string, string, ...string) error); ok {
		r0 = rf(sentinel, sentinelPort, monitor...)
	} else {
		r0 = ret.Error(0)
	}
...
// GetSentinelRememberedMaster provides a mock function with given fields: rFailover
func (_m *RedisFailoverCheck) GetSentinelRememberedMaster(rFailover *v1.RedisFailover) (string, error) {
	ret := _m.Called(rFailover)

	if len(ret) == 0 {
		panic("no return value specified for GetSentinelRememberedMaster")
	}
...
// IsHAProxyRunning provides a mock function with given fields: rFailover
func (_m *RedisFailoverCheck) IsHAProxyRunning(rFailover *v1.RedisFailover) bool {
	ret := _m.Called(rFailover)

	if len(ret) == 0 {
		panic("no return value specified for IsHAProxyRunning")
	}
