...
type SharedInformerFactory interface {
	...
	Databases() redisfailover.Interface
}

func (f *sharedInformerFactory) Databases() redisfailover.Interface {
	return redisfailover.New(f, f.namespace, f.tweakListOptions)
}
